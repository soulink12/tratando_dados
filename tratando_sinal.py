...
class Sinal:
    ...
    def __init__(self, sinal_path):
        ...
        self.sinal_modificado = self.criar_sinal_modificado(self.sinal_original, self.inicio, 0.05)
...
#sinal = Sinal(r'C:\Users\souli\OneDrive\Trabalho\UFPA\Mestrado\Trabalho\medições\ultrassom-refeito\trilho\s11-premium\cisalhante\2\0\0.txt')
#print(sinal.tempo_propagacao)
